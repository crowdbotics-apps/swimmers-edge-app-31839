...
## Project Structure
    ...
    ├── swimmers_edge_app_31839  # Django project configurations
...
1. Clone this repo and `cd swimmers_edge_app_31839`
...
2. Clone this repo and `cd swimmers_edge_app_31839`
